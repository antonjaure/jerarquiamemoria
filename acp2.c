...
int main(int argc, char *argv[]) {
    ...
    int elementos_por_linea = CLS / sizeof(int); // Esto da 16
    int R;
    ...
    size_t num_bytes = (max_indice + 1) * sizeof(int);
    ...
    int * A = (int *)aligned_alloc(CLS, num_bytes); // A es un array de doubles, alineado a CLS, con el tamaño necesario para R accesos con stride D
    if(A == NULL) {
        free(indices);
